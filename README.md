...
"](https://arxiv.org/abs/2404.00124) that describes the research on the Sorani Kurdish subdialect recognition. More than 120 individuals were interviewed (a list of the names of those whoc concented on their name to be pulically share is found [here](https://github.com/KurdishBLARK/Soarni-Nas/blob/main/participants.pdf)), of whom about 30 hours of speech were collected. This repository shows samples of the data because the size of the wav files does not allow us to share them here. We are planning to share the whole dataset with the community very soon.
